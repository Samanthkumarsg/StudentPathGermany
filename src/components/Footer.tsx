    ...
    return (
        <div className="border border-t-0 pt-10 px-5 relative overflow-hidden bg-white/20 backdrop-sepia-0">
            ...
            <div className="flex flex-col p-5 rounded-xl  bg-white/50">
                <h1 className="font-normal text-center tracking-tight bg-linear-to-r from-stone-800 to-violet-500 bg-clip-text text-transparent text-5xl mb-12"> Move. Live. Grow.</h1>
                <div className=' flex flex-col items-start justify-center'>
                    <h1 className="font-semibold tracking-tight bg-linear-to-r from-stone-800 to-violet-500 bg-clip-text text-transparent text-lg mb-2"> StudentPathGermany</h1>

                    <h1 className='scroll-m-20 text-left font-normal tracking-tight text-balance mb-4 bg-gradient-to-r from-stone-800 to-violet-800 bg-clip-text text-transparent text-2xl/10'>We help international students start their journey in Germany with housing, legal support, banking, and job connections — all in one place.</h1>
                </div>
                <div className=''>
                    ...
                    <div className="text-sm text-stone-600 mt-6 flex items-end justify-center">
                        © 2025 YourPlatform – All rights reserved
                    </div>
                </div>
            </div>
        </div>
