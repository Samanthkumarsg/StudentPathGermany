    ...
    return (
        <div className="border border-t-0 px-5 py-18 relative overflow-hidden bg-white/70 backdrop-sepia-0">
            ...
            <div className="grid grid-cols-2 items-center justify-center p-5 ">
                <div className=''>
                    <h1 className="font-semibold tracking-tight bg-linear-to-r from-stone-800 to-violet-500 bg-clip-text text-transparent text-lg mb-4"> StudentPathGermany</h1>

                    <h1 className='scroll-m-20 text-left font-normal tracking-tight text-balance mb-4 bg-gradient-to-r from-stone-800 to-violet-800 bg-clip-text text-transparent text-2xl/10'>Our platform makes your arrival so easy from the airport pickup to finding your first job in Germany in simple steps.</h1>
                </div>
                <div className=' flex items-end justify-center flex-col'>
                    <div className='flex flex-col *:flex-col gap-8 text-md  '>
                        <div className=''>
