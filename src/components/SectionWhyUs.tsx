...
const SectionWhyUs = () => {
    return (
        <div className="max-w-6xl mx-auto p-4 z-60 border border-t-0 -rounded-t-xl  pt-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3  bg-white/20 backdrop-sepia-0 *:bg-gradient-to-r *:from-stone-800 *:to-violet-800 *:bg-clip-text *:text-transparent ">
                <div className="flex flex-col p-6 border rounded-lg  ">
                    <div className="text-4xl mb-4 "><House className="size-8 stroke-1" /></div>
                ...
                <div className="flex flex-col p-6 border rounded-lg">
                    <span className="text-4xl mb-4"><Plane className="size-8 stroke-1" /></span>
                ...
                <div className="flex flex-col p-6 border rounded-lg">
                    <span className="text-4xl mb-4"><GraduationCap className="size-8 stroke-1" /></span>
                ...
                <div className="flex flex-col p-6 border rounded-lg col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-2 xl:col-span-2 ">
                    <span className="text-4xl mb-4"><Landmark className="size-8 stroke-1" /></span>
                ...
                <div className="flex flex-col p-6 border rounded-lg col-span-2 sm:col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 ">
                    <span className="text-4xl mb-4"><Handshake className="size-8 stroke-1" /></span>
