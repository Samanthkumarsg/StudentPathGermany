...
const SectionWhyUs = () => {
    return (
        <div className="max-w-6xl mx-auto p-4 z-60 border border-t-0 -rounded-t-xl  pt-8">
            <div className=' mb-8'>
                <div className='text-xl font-semibold text-stone-600 flex items-center justify-center bg-gradient-to-r from-stone-800 to-violet-800 bg-clip-text text-transparent '>
                    Services we provide
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3  bg-white/70 backdrop-sepia-0 scroll-m-20  font-normal  *:bg-gradient-to-r *:from-stone-800 *:to-violet-800 *:bg-clip-text *:text-transparent ">
                ...
                <div className="flex flex-col p-5 border rounded-lg  ">
                    ...
                    <h3 className="text-md font-medium mb-1">Find Housing Easily</h3>
                    <p className='text-stone-600 font-normal text-sm'>Verified apartments, dorms, and shared flats matched to your budget.</p>
                </div>

                <div className="flex flex-col p-5 border rounded-lg">
                    <span className="text-4xl mb-3 text-stone-800"><Plane className="size-8 stroke-1" /></span>
                    <h3 className="text-md font-medium mb-1">Seamless Arrival</h3>
                    <p className='text-stone-600 font-normal text-sm'>Airport pickup, train/bus ticket, and temporary stay arranged before you land.</p>
                </div>
                <div className="flex flex-col p-5 border rounded-lg">
                    <span className="text-4xl mb-3 text-stone-800"><GraduationCap className="size-8 stroke-1" /></span>
                    <h3 className="text-md font-medium mb-1">Kickstart Your Career</h3>
                    <p className='text-stone-600 font-normal text-sm'>Part-time job opportunities, CV/resume support, and consulting.</p>
                </div>
                ...
                <div className="flex flex-col p-5 border rounded-lg col-span-2 sm:col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-1 ">
                    ...
                    <h3 className="text-md font-medium mb-1">Community Support</h3>
                    <p className='text-stone-600 font-normal text-sm'>Join student groups and events to build your network in Germany.</p>
                </div>
            </div>
        </div>
