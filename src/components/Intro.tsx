...
const Intro = () => {
    return (
        <div className=" max-w-7xl mx-auto relative p-4 border border-b-0 flex items-center justify-center -rounded-b-md overflow-hidden">
            ...
            <div className="relative p-8 mb-8 border border-b-0 flex items-center justify-center w-full rounded-lg -rounded-b-0 bg-white/60 backdrop-sepia-0 ">
                <div className="max-w-lg flex flex-col text-center p-3">
                    <h1 className="scroll-m-20 text-center font-semibold tracking-tight text-balance mb-4 bg-gradient-to-r from-stone-800 to-violet-500 bg-clip-text text-transparent text-5xl">
                        Your Friendly support from arrival
                    </h1>
                    <h2 className="scroll-m-20 text-xl font-normal tracking-tight text-stone-800">
                        From landing in Germany to settling, we guide you through airport pickup, housing support and legal services.
                    </h2>
                    <div className="flex flex-wrap items-center justify-center gap-2 md:flex-row mt-10">
                        <Button data-tally-open="3q90rY" data-tally-hide-title="1" data-tally-overlay="1" data-tally-form-events-forwarding="1" className="outline-2 outline-offset-6 outline-stone-400 outline-dashed shadow-md text-md">
                            Get Started!
                        </Button>
                        <div className=''>
                            <Undo className="size-20 stroke-1 absolute text-stone-900  rotate-150 left-1/3 mt-5" />
                        </div>
                    </div>
                </div>
            </div>
